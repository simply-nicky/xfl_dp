...
class XFLData:
    def __init__(self, rnum, cnum, tag, output_folder=os.path.dirname(__file__), online=True):
...
def main():
    ...
    parser.add_argument('--online', action='store_true', help='online - cheetah data in Maxwell cluster')
    parser.add_argument('-v', '--verbosity', action='store_true', help='increase output verbosity')
    args = parser.parse_args()

    xfl_data = XFLData(args.rnum, args.cnum, args.tag, args.outpath, args.online)
    if args.verbosity:
