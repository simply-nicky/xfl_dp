...
class XFLData:
    ...
    def data(self, limit=20000):
        return xfl_dp.data(self.cheetah_path, self.data_size, limit)

    def splitted_data(self, pids, limit=20000):
        return xfl_dp.splitted_data(self.cheetah_path, self.data_size, pids, limit)

    def write(self, limit=20000):
        xfl_dp.write_data(self.cheetah_path, self.output_path, self.data_size, limit)
